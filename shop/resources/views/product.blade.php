                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="{{$p->image_name}}" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-$50</p>
                                                </div>
                                            </div>
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">{{$p->name}}</a></h5>
                                                <ul class="rating">
                                                ...
                                                <span class="regular-price">${{$p->sale_price}}</span>
                                                <span class="discount-price">${{$p->price}}</span>
                                                <hr>
                                                <add-to-cart-button product_id="{{$p->id}}"
